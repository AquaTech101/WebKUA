    ...
    <div class="form-container">
        <div class="form-wrap">
            <div class="wrap-nikah bg0">
                ...
                <strong class="Left">adalah benar ayah kandung dan ibu kandung dari seorang :</strong><br><br>
                ...
                <strong class="Left">dengan seorang wanita :</strong><br><br>
