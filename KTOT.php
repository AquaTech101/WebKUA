    ...
    <div class="form-container">
        <div class="form-wrap">
            <div class="wrap-nikah bg0">
                <p class="Right">Model : N-4</p>

                <strong class="Center"><u><?php echo $_POST["tipe"]; ?></u></strong><br>

                <strong class="Left">Yang bertanda tangan dibawah ini menerangkan dengan sesungguhnya bahwa :</strong>
                ...
                <strong class="Left">adalah benar ayah kandung dan ibu kandung dari seorang :</strong>
                ...
                <p class="Left">Tempat Tinggal : <?php echo $_POST["tinggal-anak"]; ?></p><br>
