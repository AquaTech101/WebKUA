            ...
            <div class="wrap-nikah nikah-select bg1">
                ...
                <div>
                    <select id="selected" onchange="special()" name="selectedOps" class="form-control">
                            <option selected value="KAU">Keterangan Asal-Usul</option>
                            <option value="PM">Persetujuan Mempelai</option>
                            <option value="KTOT">Keterangan Tentang Orang Tua</option>
                            <option value="SIOT">Izin Orang Tua</option>
                            <option value="SKK">Keterangan Kematian Suami/Istri</option>
                            <option value="PKN">Pemberitahuan Kehendak Nikah</option>
                            <option value="SKUN">Keterangan Untuk Nikah</option>
						</select>
                </div>
            </div>
